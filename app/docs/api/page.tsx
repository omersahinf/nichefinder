...
export default function ApiDocsPage() {
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <header className="mb-8 mt-6">
          ...
          <p className="mt-2 text-sm text-neutral-400">
            Use Bearer-authenticated search requests against the shared NicheFinder cache and live
        ...
        <section className="mb-8 rounded-lg border border-neutral-800 bg-neutral-900/50 p-6">
          ...
          <pre className="mt-4 overflow-x-auto rounded bg-neutral-950 p-4 text-sm text-neutral-200">
            <code>GET /api/v1/search?q=faceless+finance&amp;max=25&amp;minOutlier=2&amp;sort=outlier</code>
          </pre>
        </section>
        ...
        <section className="mb-8 rounded-lg border border-neutral-800 bg-neutral-900/50 p-6">
          ...
          <div className="mt-4 grid gap-3 text-sm text-neutral-300">
            <div><code>q</code> required query string</div>
            <div><code>max</code> 5-50 results</div>
            ...
            <div><code>force=1</code> bypasses cache for keyword searches</div>
          </div>
        </section>
  ...
  "${process.env.NEXT_PUBLIC_APP_URL?.trim() || "http://localhost:3000"}/api/v1/search?q=ai+tools&minOutlier=2&max=10"`}</code>
          </pre>
        </section>
      </div>
    </main>
